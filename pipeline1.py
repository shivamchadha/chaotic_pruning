...
model.load_state_dict(torch.load(rf"initializations/mnist/model_{initialization}.pth", map_location = device))
train_size = 0.7
...
if mask:
    mask_list = (np.genfromtxt(rf"masks/mask_mnist_{initialization}.csv", delimiter=',')+39200).tolist()
    lim0 = 1
    model_tensors = {}
